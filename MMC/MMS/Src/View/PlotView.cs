...
namespace MMS.View
{
    ...
    public class PlotView : Control, IPlotView
    {
        ...
        /// The tracker label.
        /// </summary>
        [NonSerialized] private Label trackerLabel;

        /// <summary>
        /// The current model (holding a reference to this plot view).
        /// </summary>
        [NonSerialized] private PlotModel currentModel;
        ...
        {
            get { return this.ActualController; }
        }
        ...
        public OxyRect ClientArea
        {
            get
            {
                return new OxyRect(this.ClientRectangle.Left, this.ClientRectangle.Top, this.ClientRectangle.Width,
        ...
        {
            this.zoomRectangle = new Rectangle((int)rectangle.Left, (int)rectangle.Top, (int)rectangle.Width,
