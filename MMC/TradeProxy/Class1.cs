...
namespace TradeProxy
{
    public class TestFindForm
    {
        ...
        public void Test() 
        {
            var ids = FindWindowEx(IntPtr.Zero, IntPtr.Zero, null, null);
            var id2 = GetWindow(ids, GW_HWNDNEXT);
            var id = FindWindow("Afx:400000:b:10003:6:298f09d3", null);
        }

        public int Test(IntPtr handle)
        {
        ...
        public void EnumChildWindowsCallback(IntPtr handle)
        {
            var MainViewBar = FindWindowEx(handle, IntPtr.Zero, "AfxFrameOrView42", null);
        ...
        public int FindBuy(IntPtr handle)
        {
            var id = FindWindowEx(handle, IntPtr.Zero, null, "买 入");
